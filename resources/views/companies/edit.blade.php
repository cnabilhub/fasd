...
@section('content')
    <div class="p-4">
        ...
        <form action="{{ route('companies.update',$company->id) }}" method="PUT" class="container mx-auto" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid gap-x-8 gap-y-4 md:grid-cols-2  sm:grid-cols-1 ">
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Nom de l entreprise : </div>
            ...
            <div class="mb-2 relative">
                <div class="text-sm text-gray-500 mb-2"> Description courte: </div>
                <div class="absolute ml-4 mt-2 text-indigo-400">
            ...
            <div
                ...
                <div>
                    <div class="text-sm text-gray-500 mb-2"> Logo : </div>
                    <img src="@if ($company->img){{ asset('/storage/avatars') . '/' . $company->img }}@else{{ asset('/img/default.jpg') }}@endif" alt="" srcset=""
            ...
            <div class="grid gap-x-8 gap-y-4 md:grid-cols-2  sm:grid-cols-1 ">
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Telephone : </div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Registre du commerce et des sociétés</div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> TVA taxe sur la valeur ajoutée</div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
                        <i class="fas fa-money-check-alt"></i>
                    </div>
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Numéro TVA Intracommunautaire </div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
                        <i class="fas fa-money-check-alt"></i>
                    </div>
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Pays</div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
                        <i class="fas fa-map-pin"></i>
                    </div>
                ...
                <div class="mb-2 relative">
                    <div class="text-sm text-gray-500 mb-2"> Note :</div>
                    <div class="absolute ml-4 mt-2 text-indigo-400">
